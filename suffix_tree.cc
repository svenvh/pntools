 ...
 *      Author: Teddy Zhai
 *
 *      The implementation is inspired by the description from Mark Nelson.
 *       This code has been developed in the context of paper:
 *       "Automated Synthesis of Hard-Real-Time Embedded Streaming Systems"
 */
